...
function OsapClientsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Google Sheets / Spreadsheet Style Dated Batch Tabs Navigation */}
      <div className="bg-card border-2 border-gold/30 rounded-xl p-3.5 shadow-md space-y-2.5">
            ...
            <div>
              <h2 className="font-bold text-foreground text-sm tracking-tight flex items-center gap-2">
                ...
                <span className="text-[11px] px-2 py-0.5 rounded-full bg-gold/20 text-gold font-mono font-semibold">
                  {uniqueBatches.length} Batches ({clients.length} Students)
                </span>
              </h2>
              <p className="text-[11px] text-muted-foreground">
                Click any dated batch tab below to inspect, manage, and audit that cohort specifically.
              </p>
            </div>
          </div>
        ...
        {/* Scrollable Dated Batch Tabs Ribbon */}
