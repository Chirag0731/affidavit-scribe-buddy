...
const LOCAL_CLIENTS_KEY = "neptora_osap_clients_cache";
...
export const INITIAL_SPREADSHEET_CLIENTS: OsapClient[] = [
  {
    id: "osap-client-01-ahmad-banat",
    user_id: "system",
    first_name: "Ahmad",
    last_name: "Banat",
  ...
  {
    id: "osap-client-04-erika-acevedo",
    user_id: "system",
    first_name: "Erika",
    last_name: "Acevedo",
  ...
  {
    id: "osap-client-05-erishwar-venkasammy",
    user_id: "system",
    first_name: "Erishwar",
    ...
    priority: "medium",
    action_required: false,
    created_at: "2026-08-18T10:04:00Z",
    updated_at: "2026-08-18T10:04:00Z",
  },
  {
    id: "osap-client-06-gurpreet-kaur",
    user_id: "system",
    first_name: "Gurpreet",
    last_name: "kaur",
  ...
  },
  {
    ...
    priority: "medium",
    action_required: false,
    created_at: "2026-08-18T10:06:00Z",
    updated_at: "2026-08-18T10:06:00Z",
  },
  {
    id: "osap-client-08-muhammad-humyun-khan",
    user_id: "system",
    first_name: "Muhammad",
  ...
  {
    id: "osap-client-09-muneeb-ahmed-khan",
    user_id: "system",
    first_name: "Muneeb",
  ...
  {
    id: "osap-client-10-pankaj-gandhi",
    user_id: "system",
    first_name: "Pankaj",
    last_name: "Gandhi",
    ...
    priority: "medium",
    action_required: false,
    created_at: "2026-08-18T10:09:00Z",
    updated_at: "2026-08-18T10:09:00Z",
  },
  {
    id: "osap-client-11-ramandeep-singh",
    user_id: "system",
    ...
    funding_status: "On Hold",
    msfaa_status: "required",
    document_status: "received",
    priority: "high",
    action_required: true,
    action_required_summary: "SIN Registry personal information discrepancy. DOB: Apr 19/96.",
    notes: "Email Address not validated yet. Your OSAP applications are on hold because there is a discrepancy between the basic personal information that you provided when you registered for OSAP and the information on file at the Social Insurance Number Registry at Employment and Social Development Canada (ESDC). DOB: Apr 19/96",
    created_at: "2026-08-18T10:10:00Z",
    updated_at: "2026-08-18T10:10:00Z",
  },
  {
    id: "osap-client-12-ravandeep-singh",
    user_id: "system",
    ...
    priority: "high",
    action_required: true,
    action_required_summary: "SIN Registry personal information discrepancy. DOB: Aug 1/94.",
    notes: "Email Address not validated yet. Your OSAP applications are on hold because there is a discrepancy between the basic personal information that you provided when you registered for OSAP and the information on file at the Social Insurance Number Registry at Employment and Social Development Canada (ESDC). DOB: Aug 1/94",
    created_at: "2026-08-18T10:11:00Z",
    updated_at: "2026-08-18T10:11:00Z",
  },
  {
    id: "osap-client-13-sharanjeet-singh",
    user_id: "system",
    ...
    updated_at: "2026-08-18T10:12:00Z",
  },
  {
    id: "osap-client-14-waleed-ali",
    user_id: "system",
    first_name: "Waleed",
    last_name: "Ali",
    ...
    updated_at: "2026-08-18T10:13:00Z",
  },
  {
    id: "osap-client-15-yuri-glerup",
    user_id: "system",
    first_name: "Yuri",
    last_name: "Glerup",
    ...
    updated_at: "2026-08-18T10:14:00Z",
  },
];
