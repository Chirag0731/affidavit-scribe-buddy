...
export const ALL_OSAP_CLIENTS: OsapClient[] = [
  ...
  },
  {
    ...
    "credential_status": "connected",
    "application_status": "action_required",
    "funding_status": "Disbursement Blocked (Spouse Declaration Required)",
    ...
    "notes": "Spouse declaration and signature form required (Jul 28/26). Form password: h7jbG46w. Academic restriction upload received Sep 8/26.",
